...
public class AddressBookController {
    ...
    private void openSearch(){
        ...
        String reply=JOptionPane.showInputDialog(null,"enter a string","search",1);
    }
    ...
    public Boolean validate(){
     ...
     public Boolean mobvalid(){
        ...
        if (mobile.length()<10 || mobile.length()>10)
            JOptionPane.showMessageDialog(new JFrame(), "mobile number must contain 10 characters","Inane error", JOptionPane.ERROR_MESSAGE);
        else 
            valid = true;
        return valid;
